...
# # Gemini config
# GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", 'AIzaSyAJ9bLWqpx937LWpv8nWzLjHnr7Cg_eUdM')
...
#     user = FAKE_DB["users"].get(user_email, {"plan": "free"})
...
#     user = FAKE_DB["users"].setdefault(email, {"password": "", "plan": "free"})
#     if request.method == "POST":
